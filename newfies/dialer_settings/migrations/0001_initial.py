    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_frequency', models.IntegerField(default=b'5000', help_text='maximum calls per minute', null=True, verbose_name='max frequency', blank=True)),
                ...
                ('maxretry', models.IntegerField(default=b'1', help_text='maximum retries per user.', null=True, verbose_name='max retries', blank=True)),
                ...
                ('max_subr_cpg', models.IntegerField(default=1000000, help_text='maximum subscribers per campaign. Unlimited if the value equal 0', verbose_name='maximum subscribers per campaign')),
                ...
                ('sms_max_frequency', models.IntegerField(default=b'5000', help_text='Maximum SMS per minute', null=True, verbose_name='Max frequency', blank=True)),
                ('sms_maxretry', models.IntegerField(default=b'1', help_text='Maximum SMS retries per user.', null=True, verbose_name='Max Retries', blank=True)),
                ('sms_max_number_campaign', models.IntegerField(default=100, help_text='Maximum number of SMS campaigns', verbose_name='Max SMS campaigns')),
                ('sms_max_number_subscriber_campaign', models.IntegerField(default=1000000, help_text='Maximum subscribers per SMS campaign', verbose_name='Max subscribers of SMS campaigns')),
