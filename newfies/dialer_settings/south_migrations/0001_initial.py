...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dialer_setting', (
            ...
            ('max_frequency', self.gf('django.db.models.fields.IntegerField')(default='5000', null=True, blank=True)),
            ('callmaxduration', self.gf('django.db.models.fields.IntegerField')(default='1800', null=True, blank=True)),
            ('maxretry', self.gf('django.db.models.fields.IntegerField')(default='1', null=True, blank=True)),
            ...
            ('max_number_subscriber_campaign', self.gf('django.db.models.fields.IntegerField')(default=1000000)),
