...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('dialer_setting', 'sms_max_frequency',
                      self.gf('django.db.models.fields.IntegerField')(default='5000', null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        u'dialer_settings.dialersetting': {
            ...
            'max_subr_cpg': ('django.db.models.fields.IntegerField', [], {'default': '1000000'}),
            'maxretry': ('django.db.models.fields.IntegerField', [], {'default': "'1'", 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'sms_max_frequency': ('django.db.models.fields.IntegerField', [], {'default': "'5000'", 'null': 'True', 'blank': 'True'}),
            'sms_max_number_campaign': ('django.db.models.fields.IntegerField', [], {'default': '100'}),
            'sms_max_number_subscriber_campaign': ('django.db.models.fields.IntegerField', [], {'default': '1000000'}),
            'sms_maxretry': ('django.db.models.fields.IntegerField', [], {'default': "'1'", 'null': 'True', 'blank': 'True'}),
